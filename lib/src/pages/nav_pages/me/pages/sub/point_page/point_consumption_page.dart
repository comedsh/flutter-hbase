...
class PointConsumptionPage extends StatefulWidget {
  final Pager<PointConsumption> pager;
  const PointConsumptionPage({super.key, required this.pager});

  @override
  PointConsumptionPageState createState() => PointConsumptionPageState();
}

class PointConsumptionPageState extends State<PointConsumptionPage> {
  final PagingController<int, PointConsumption> pagingController = PagingController(firstPageKey: 1);
  ...
  rows() {
    return PagedListView<int, PointConsumption>(
        pagingController: pagingController,
        builderDelegate: PagedChildBuilderDelegate<PointConsumption>(
          ...
          itemBuilder: (context, pointConsumption, index) => 
            Column(
              children: [
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Align(alignment: Alignment.centerRight, child: Padding(
                          ...
                          child: Text(pointConsumption.points.toString()),
                        )),
                      ),
                    ),
                    Expanded(
                      ...
                      child: Padding(
                        padding: EdgeInsets.symmetric(horizontal: sp(8)),
                        child: Align(alignment: Alignment.centerLeft, child: Text(pointConsumption.spentDesc)),
                      ),
                    ),
                  ],
                ),
